...
$script_file = ConfigHelper::getConfig('libreqos.script_file', "/etc/rc.d/rc.htb");
$script_file_day = ConfigHelper::getConfig('libreqos.script_file_day', "/etc/rc.d/rc.htb.day");
$script_file_night = ConfigHelper::getConfig('libreqos.script_file_night', "/etc/rc.d/rc.htb.night");
$script_permission = ConfigHelper::getConfig('libreqos.script_permission', "0700");
$script_begin = ConfigHelper::getConfig('libreqos.begin', "#!/bin/bash\n\nPATH=\"/bin:/sbin:/usr/bin:/usr/sbin\"\n\n");
$script_begin_day = ConfigHelper::getConfig('libreqos.begin_day', $script_begin);
$script_begin_night = ConfigHelper::getConfig('libreqos.begin_night', $script_begin);
$script_end = ConfigHelper::getConfig('libreqos.end', '', true);
$script_end_day = ConfigHelper::getConfig('libreqos.end_day', $script_end);
$script_end_night = ConfigHelper::getConfig('libreqos.end_night', $script_end);
$script_class_up = ConfigHelper::getConfig('libreqos.class_up', '', true);
$script_class_up_day = ConfigHelper::getConfig('libreqos.class_up_day', $script_class_up);
$script_class_up_night = ConfigHelper::getConfig('libreqos.class_up_night', $script_class_up);
$script_class_down = ConfigHelper::getConfig('libreqos.class_down', '', true);
$script_class_down_day = ConfigHelper::getConfig('libreqos.class_down_day', $script_class_down);
$script_class_down_night = ConfigHelper::getConfig('libreqos.class_down_night', $script_class_down);
$script_filter_up = ConfigHelper::getConfig('libreqos.filter_up', '', true);
$script_filter_up_day = ConfigHelper::getConfig('libreqos.filter_up_day', '', true);
$script_filter_up_night = ConfigHelper::getConfig('libreqos.filter_up_night', '', true);
$script_filter_down = ConfigHelper::getConfig('libreqos.filter_down', '', true);
$script_filter_down_day = ConfigHelper::getConfig('libreqos.filter_down_day', '', true);
$script_filter_down_night = ConfigHelper::getConfig('libreqos.filter_down_night', '', true);
$script_climit = ConfigHelper::getConfig('libreqos.climit', '', true);
$script_plimit = ConfigHelper::getConfig('libreqos.plimit', '', true);
...
$networks = ConfigHelper::getConfig('libreqos.networks', '', true);
$networks = preg_split('/(\s+|\s*,\s*)/', $networks, -1, PREG_SPLIT_NO_EMPTY);

// exclude networks set in config value
$excluded_networks = ConfigHelper::getConfig('libreqos.excluded_networks', '', true);
...
// customer groups
$customergroups = ConfigHelper::getConfig('libreqos.customergroups', '', true);
